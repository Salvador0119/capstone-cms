...
export interface ApiSigninInfoSigninInfo extends Schema.CollectionType {
  collectionName: 'signin_infos';
  info: {
    singularName: 'signin-info';
    pluralName: 'signin-infos';
    displayName: 'signin-info';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiUserTypeUserType extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['Admin', 'Cashier', 'Mechanic']>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::signin-info.signin-info': ApiSigninInfoSigninInfo;
